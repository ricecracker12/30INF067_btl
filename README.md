...
| **GĐ3** — Bình luận 3 cấp + cảm xúc ([`docs/giai-doan-3/giai-doan-3.md`](docs/giai-doan-3/giai-doan-3.md)) | **Chạy thật trên staging** (2026-09-25): 8 endpoint `content-v1` (`1.1.0-gd3`), bộ đếm khóa dòng + jsonb nguyên tử (`COUNT-01..04`, 12 đột biến B3 bị bắt, đối soát staging 0 dòng), cây bình luận + thanh cảm xúc optimistic, E2E hai tài khoản thật xanh trên staging. F1–F4 xong; còn F5 (k6 lượt lạnh, đóng băng `content-v1`) |
| GĐ8 | Chưa mở |
