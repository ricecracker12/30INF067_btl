...
- **Frontend (khối E) — đang làm:**
  - xong: E1 (scaffold + kit UI), E2 (api client sinh từ hợp đồng, MSW cho Vitest)
  - đang làm: E4 (màn đăng nhập)
  - còn lại: E3 đăng ký, E5 xác minh email, E6 guard + `/me`, E7 refresh single-flight, E8 đóng gói FE cho staging
...
DB không seed sẵn người dùng nào. Khi các màn E3/E5 chưa xong, tạo tài khoản qua Swagger:

1. `POST /api/v1/auth/register` với `{"email":"a@example.com","password":"matkhau123"}` → 201.
