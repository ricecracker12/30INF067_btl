...
/// <summary>
/// Quyền đơn lẻ (ENT-10a, bảng <c>permissions</c>). Mười bảy dòng của Mục 5.2, <c>permission_id</c>
/// gán tay 1..17 nên cũng KHÔNG để EF tự sinh.
/// </summary>
public sealed class Permission
{
    /// <summary>Khóa chính <c>smallint</c>, gán tay 1..17. A2 phải cấu hình <c>ValueGeneratedNever()</c>.</summary>
